  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      ...
      <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
        <p className="font-medium text-center mb-2">Trusted by</p>
        <div className="flex flex-wrap justify-center items-center gap-6">
        <img className="h-6 object-contain" src={assets.microsoft_logo} />
        <img className="h-6 object-contain" src={assets.walmart_logo} />
        <img className="h-6 object-contain" src={assets.accenture_logo} />
        <img className="h-6 object-contain" src={assets.samsung_logo} />
        <img className="h-6 object-contain" src={assets.amazon_logo} />
        <img className="h-6 object-contain" src={assets.adobe_logo} />
      </div>
